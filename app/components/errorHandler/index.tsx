...
export const ErrorHandler = (props: Props) => {
  ...
  switch (error!.constructor) {
    case NotFoundError:
      return (
        <Container center tight className="error-handler">
          <h1 className="title">Not found</h1>
          <h1 className="subtitle">{error.message}</h1>

          <Section>
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1120.59226 777.91584">
              <circle cx="212.59226" cy="103" r="64" fill="#F24821" />
              <path
                ...
                transform="translate(-39.70387 -61.04208)" fill="var(--c-shade--light)" />
              <polygon
              ...
              <polygon
                ...
                fill="var(--c-shade--darker)" />
              <ellipse cx="554.59226" cy="680.47903" rx="554.59226" ry="28.03433" fill="var(--c-shade--darker)" />
              <ellipse cx="892.44491" cy="726.79663" rx="94.98858" ry="4.80162" fill="var(--c-shade--darker)" />
              <ellipse cx="548.71959" cy="773.11422" rx="94.98858" ry="4.80162" fill="var(--c-shade--darker)" />
              <ellipse cx="287.94432" cy="734.27887" rx="217.01436" ry="10.96996" fill="var(--c-shade--darker)" />
              <circle cx="97.08375" cy="566.26982" r="79" fill="var(--c-shade--full)" />
              <rect x="99.80546" y="689.02332" width="24" height="43" transform="translate(-31.32451 -62.31008) rotate(0.67509)"
                fill="var(--c-shade--full)" />
              ...
              <ellipse cx="119.54569" cy="732.61606" rx="7.5" ry="20" transform="translate(-654.1319 782.47948) rotate(-89.32491)"
                fill="var(--c-shade--full)" />
              <ellipse cx="167.55414" cy="732.18168" rx="7.5" ry="20" transform="translate(-606.25475 830.05533) rotate(-89.32491)"
                fill="var(--c-shade--full)" />
              <circle cx="99.31925" cy="546.29477" r="27" fill="#fff" />
              <circle cx="99.31925" cy="546.29477" r="9" fill="var(--c-shade--darker)" />
              <path
                ...
                transform="translate(-39.70387 -61.04208)" fill="var(--c-brand--default)" />
              <path
              ...
              <path
                ...
                transform="translate(-39.70387 -61.04208)" fill="var(--c-shade--darker)" />
              <circle cx="712.48505" cy="565.41532" r="79" fill="var(--c-shade--full)" />
              <rect x="741.77716" y="691.82355" width="24" height="43" transform="translate(-215.99457 191.86399) rotate(-17.08345)"
                fill="var(--c-shade--full)" />
              <rect x="787.6593" y="677.72286" width="24" height="43"
                transform="matrix(0.95588, -0.29376, 0.29376, 0.95588, -209.82788, 204.72037)" fill="var(--c-shade--full)" />
              <ellipse cx="767.887" cy="732.00275" rx="20" ry="7.5" transform="translate(-220.8593 196.83312) rotate(-17.08345)"
                fill="var(--c-shade--full)" />
              <ellipse cx="813.47537" cy="716.94619" rx="20" ry="7.5" transform="translate(-214.42477 209.56103) rotate(-17.08345)"
                fill="var(--c-shade--full)" />
              <circle cx="708.52153" cy="545.71023" r="27" fill="#fff" />
              <circle cx="708.52153" cy="545.71023" r="9" fill="var(--c-shade--darker)" />
              <path
              ...
              <ellipse cx="721.51694" cy="656.82212" rx="12.40027" ry="39.5"
                transform="translate(-220.83517 966.22323) rotate(-64.62574)" fill="var(--c-shade--full)" />
              <ellipse cx="112.51694" cy="651.82212" rx="12.40027" ry="39.5"
                transform="translate(-574.07936 452.71367) rotate(-68.15829)" fill="var(--c-shade--full)" />
            </svg>
          </Section>
        </Container>
      )
    default:
      return <div>Unhandled error {error.message}</div>
  }
}
