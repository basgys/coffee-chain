...
contract('SupplyChain', function(accounts) {
    ...
    before(async () => {
        ...
        await supplyChain.registerFarm(originFarmerID, originFarmName, originFarmInformation, originFarmLatitude, originFarmLongitude)
        await supplyChain.registerDistributor(distributorID)
        await supplyChain.registerRetailer(retailerID)

        // Mark an item as Harvested by calling function harvestItem()
        const tx = await supplyChain.harvestItem(upc, productNotes, {from: originFarmerID})
    ...
    it("Testing smart contract function processItem() that allows a farmer to process coffee", async() => {
        ...
        // Retrieve the just now saved item from blockchain by calling function fetchItem()
        const buff = await supplyChain.fetchItemBufferTwo.call(upc)

        // Verify the result set
        assert.equal(buff.itemState, 2, 'Error: Invalid item State')
    })
    ...
    it("Testing smart contract function packItem() that allows a farmer to pack coffee", async() => {
        ...
        // Verify the result set
        assert.equal(buff.itemState, 3, 'Error: Invalid item State')
    })
    ...
    it("Testing smart contract function sellItem() that allows a farmer to sell coffee", async() => {
        ...
        // Verify the result set
        assert.equal(buff.itemState, 4, 'Error: Invalid item State')
    })
    ...
    it("Testing smart contract function buyItem() that allows a distributor to buy coffee", async() => {
        ...
        // Verify the result set
        assert.equal(buff.itemState, 5, 'Error: Invalid item State')
    })
    ...
    it("Testing smart contract function shipItem() that allows a distributor to ship coffee", async() => {
        ...
        // Verify the result set
        assert.equal(buff.itemState, 6, 'Error: Invalid item State')
    })
    ...
    it("Testing smart contract function receiveItem() that allows a retailer to mark coffee received", async() => {
        ...
        const tx = await supplyChain.receiveItem(upc, { from: retailerID, value: productPrice })
        ...
        // Verify the result set
        assert.equal(buff.itemState, 7, 'Error: Invalid item State')
    })
    ...
    it("Testing smart contract function purchaseItem() that allows a consumer to purchase coffee", async() => {
        ...
        // Verify the result set
        assert.equal(buff.itemState, 8, 'Error: Invalid item State')
    })
    ...
    it("Testing smart contract function fetchItemBufferOne() that allows anyone to fetch item details from blockchain", async() => {
        ...
        // Retrieve the just now saved item from blockchain by calling function fetchItem()
        const resultBufferOne = await supplyChain.fetchItemBufferOne.call(upc, {from: 0x0})
    ...
    it("Testing smart contract function fetchItemBufferTwo() that allows anyone to fetch item details from blockchain", async() => {
        ...
        // Retrieve the just now saved item from blockchain by calling function fetchItem()
        const resultBufferTwo = await supplyChain.fetchItemBufferTwo.call(upc, {from: 0x0})
